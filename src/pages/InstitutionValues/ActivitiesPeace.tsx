...
const ActivitiesPeace: React.FC = () => {
  ...
  const handleDownloadFile = async (fileName: string) => {
    if (fileName) {
      try {
        ...
        toast.error(
          "Failed to download Activity Peace file. Please try again."
        );
      ...
      <div className="page-content">
        <Container fluid>
          <Breadcrumb
            ...
            breadcrumbItem="Activities hosted to build universal values of peace, truth & harmony"
          />
          <Card>
            <CardBody>
...
export default ActivitiesPeace;
