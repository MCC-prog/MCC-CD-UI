...
const Malpractice_committee_Report: React.FC = () => {
    ...
    const validation = useFormik({
        ...
        validationSchema: Yup.object({
            ...
            malpracticeType: Yup.string()
            .oneOf(["Chit", "Mobile", "Calculator", "Any other"], "Please select type of malpractice")
    ...
    return (
        <React.Fragment>
            <div className="page-content">
                <Container fluid>
                    <Breadcrumb title="EXAMINATION" breadcrumbItem=" Malpractice Committee report" />
                    <Card>
                        <CardBody>
  ...
  <div className="mb-3">
    ...
    <Input
      ...
      onChange={e => validation.setFieldValue("candidateName", e.target.value)}
      placeholder="Enter Name of the Candidate"
      className={validation.touched.candidateName && validation.errors.candidateName ? "is-invalid" : ""}
    />
    {validation.touched.candidateName && validation.errors.candidateName && (
      <div className="text-danger">{validation.errors.candidateName}</div>
    )}
  </div>
</Col>
<Col lg={4}>
...
<Col lg={4}>
  <div className="mb-3">
    ...
    <Input
      ...
      onChange={e => validation.setFieldValue("dateOfExam", e.target.value)}
      className={validation.touched.dateOfExam && validation.errors.dateOfExam ? "is-invalid" : ""}
    />
    {validation.touched.dateOfExam && validation.errors.dateOfExam && (
      <div className="text-danger">{validation.errors.dateOfExam}</div>
    )}
  </div>
</Col>
<Col lg={4}>
  <div className="mb-3">
    ...
    <Input
      ...
      onChange={e => validation.setFieldValue("malpracticeType", e.target.value)}
      className={validation.touched.malpracticeType && validation.errors.malpracticeType ? "is-invalid" : ""}
    >
      <option value="">Select Type of Malpractice</option>
      <option value="Chit">Chit</option>
      <option value="Mobile">Mobile</option>
      <option value="Calculator">Calculator</option>
      <option value="Any other">Any other</option>
    </Input>
    {validation.touched.malpracticeType && validation.errors.malpracticeType && (
      <div className="text-danger">{validation.errors.malpracticeType}</div>
    )}
  </div>
</Col>
                                ...
                                <tr>
                                    ...
                                    <th>
                                        ...
                                        <Input
                                            ...
                                            onChange={(e) => handleFilterChange(e, "candidateName")}
                                        />
                                    </th>
                                    <th>Register Number
                                        <Input
