...
const Program_Wise_Exam_Result: React.FC = () => {
        ...
        try {
            ...
            validation.setValues({
                ...
                semesterNo: mappedValues.semesterNo
                    ...
                    : null,
                examType: response.examType || "", // Ensure examType is included
                semester: [], // Add default value for semester
            });
    ...
    const validation = useFormik({
        ...
        validationSchema: Yup.object({
            ...
            examType: Yup.string()
                .oneOf(["Regular", "Supplementary"], "Please select exam type")
        ...
        onSubmit: async (values, { resetForm }) => {
            ...
            formData.append("semester", values.semesterType?.value || "");
    ...
    return (
        <React.Fragment>
            <div className="page-content">
                <Container fluid>
                    <Breadcrumb title="EXAMINATION" breadcrumbItem="Program –wise Exam Results" />
                    <Card>
                        <CardBody>
                                      ...
                                      <Col lg={4}>
                                        <div className="mb-3">
                                            ...
                                            <Select
                                                ...
                                                onChange={(selected) => validation.setFieldValue("semester", selected)}
                                                className={
                                    ...
                                    <Col lg={4}>
                                        <div className="mb-3">
                                            ...
                                            <Input
                                                ...
                                                onChange={e => validation.setFieldValue("examType", e.target.value)}
                                                className={validation.touched.examType && validation.errors.examType ? "is-invalid" : ""}
                                            >
                                            ...
                                            {validation.touched.examType && validation.errors.examType && (
                                                <div className="text-danger">{validation.errors.examType}</div>
                                            )}
                                        </div>
                                    </Col>
                                    <Col sm={4}>
                                ...
                                <tr>
                                    ...
                                    <th>
                                        ...
                                        <Input
                                            ...
                                            onChange={(e) => handleFilterChange(e, "examType")}
                                        />
                                    </th>
