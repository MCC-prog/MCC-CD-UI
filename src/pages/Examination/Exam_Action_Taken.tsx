    ...
    return (
        <React.Fragment>
            <div className="page-content">
                <Container fluid>
                    <Breadcrumb title="EXAMINATION" breadcrumbItem="Student Grievances w.r.t Exam & Action taken" />
                    <Card>
                        <CardBody>
                            <form onSubmit={validation.handleSubmit}>
                                <Row>
                                    ...
                                    <Col lg={12}>
  <div className="mb-3">
    <Label>Enter the remarks/action taken by the exam center</Label>
    <Input
      type="textarea"
      name="remarks"
      ...
      className={validation.touched.remarks && validation.errors.remarks ? "is-invalid" : ""}
      rows={4}
    />
    {validation.touched.remarks && validation.errors.remarks && (
      <div className="text-danger">{validation.errors.remarks}</div>
    )}
  </div>
</Col>
                                </Row>
